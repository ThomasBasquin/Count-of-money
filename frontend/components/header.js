            ...
            <div className="w-full flex justify-between items-center py-1 rounded-lg border border-gray-500 bg-gradient-to-r from-gray-700 via-gray-900 to-black">
                ...
                <div className="flex items-center justify-end w-full">
                    ...
                    <div className="flex flex-row items-center mr-4">
                        ...
                        <button id="dropdownHoverButton" onClick={toggle} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Profile <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
